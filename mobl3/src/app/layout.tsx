...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning={isDev}>
      <head>
        <meta name="description" content="Mobl3 – Modular L3 Superchain built to create deep, and optimized liquidity for high-performant creation and trading of synthetic perpetual Assets Onchain." />
