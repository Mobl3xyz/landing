...
const feature_data: DataType[] = [
   {
      id: 1,
      title: "Margin Layer",
      desc_1: "We’ve worked with over 400 companies to build blockchain solutions for their business drfrgr.",
            ...
            <div className="row justify-content-center">
               <div className="col-xl-5 col-lg-8">
                  <div className="section-title text-center mb-50">
                     <span className="sub-title">ABOUT MOBL3</span>
                     <p className="sec-text">Mobl3 integrates the margin engine into the network, unlocking capital efficiency, composability and boosting liquidity for DEXs
                     </p>
                  </div>
               </div>
            </div>
            <div className="feature-grid-wrap">
               <div className="feature-card-grid">
                  <div className="feature-card-details">
                     <h3 className="feature-card-title">Network Layer</h3>
